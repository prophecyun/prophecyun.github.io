...
declare module Cesium {
    ...
    class Camera {
        ...
        setView(options: { destination: Cartesian3; heading: number; pitch: number; roll: number; }): void;
    ...
    class Primitive {
        dataSource: Cesium.DataSource; // Custom
        geometryInstances: any[];
        appearance: Appearance | EllipsoidSurfaceAppearance;
        modelMatrix: Matrix4;
        show: boolean;
        cull: boolean;
        debugShowBoundingVolume: boolean;
