...
export class AppConfig {
  ...
  F24_BASE_URL = 'https://data-live.flightradar24.com/';
  F24_URL = this.F24_BASE_URL + 'zones/fcgi/feed.js?';
  BOUNDS = 'bounds=38.67,-14.82,67.30,136.67';
  OPTIONS = '&faa=1&mlat=1&flarm=1&adsb=1&gnd=1&air=1&vehicles=1&estimated=1';
  F24_SELECTED_FLIGHT_URL = this.F24_BASE_URL + 'clickhandler/?version=1.5&flight=';
