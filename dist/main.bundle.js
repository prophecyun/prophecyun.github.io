...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__module_primeng_module__ = __webpack_require__("./src/app/module/primeng.module.ts");
...
var AppMapComponent = /** @class */ (function () {
   ...
   -----------------------------------------------------------------------------------*/
    ...
    AppMapComponent.prototype.initDynamicDataSources = function () {
        var _this = this;
        var trackDataSource = this.loadMapLayerService.initAirTracks(this.cesiumViewer, this.cesiumDynamicDataSources);
        ...
        setInterval(function () {
            _this.f24TrackDataService.updateTracks(trackDataSource, _this.cesiumDrawingToolsProperties.pickedEntity);
        }, 5000);
    };
...
var AppConfig = /** @class */ (function () {
    function AppConfig(iconConfig) {
        ...
        this.F24_BASE_URL = 'https://data-live.flightradar24.com/';
        this.F24_URL = this.F24_BASE_URL + 'zones/fcgi/feed.js?';
        this.BOUNDS = 'bounds=38.67,-14.82,67.30,136.67';
        this.OPTIONS = '&faa=1&mlat=1&flarm=1&adsb=1&gnd=1&air=1&vehicles=1&estimated=1';
        this.F24_SELECTED_FLIGHT_URL = this.F24_BASE_URL + 'clickhandler/?version=1.5&flight=';
        this.LAYER_NAMES = {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__f24TrackData_service__ = __webpack_require__("./src/app/service/f24TrackData.service.ts");
...
var CesiumService = /** @class */ (function () {
    function CesiumService(appConfig, f24TrackDataService) {
        ...
        cesiumViewer.screenSpaceEventHandler.setInputAction(function (click) {
            ...
            if (Cesium.defined(pickedEntity) && pickedEntity.id && pickedEntity.id.id) {
                ...
                if (cesiumDrawingToolsProperties.pickedEntity.type
                    ...
                    _this.handleTrackSelection(cesiumViewer, cesiumDrawingToolsProperties);
                }
                else {
                ...
                _this.initContextDialog(cesiumViewer, windowXYPosition, cesiumDrawingToolsProperties);
            }
        }, Cesium.ScreenSpaceEventType.LEFT_CLICK);
    };
    CesiumService.prototype.handleTrackSelection = function (cesiumViewer, cesiumDrawingToolsProperties) {
        var dataSource = this.getDataSource(cesiumViewer, this.appConfig.LAYER_NAMES.airTrackLayerName);
        if (cesiumDrawingToolsProperties.pickedEntity.type === this.appConfig.LAYER_NAMES.airTrackLayerName) {
            ...
            if (cesiumDrawingToolsProperties.pickedEntity.data[0]) {
                var f24Id = cesiumDrawingToolsProperties.pickedEntity.data[0]['content'];
    ...
    CesiumService.prototype.initContextDialog = function (cesiumViewer, windowXYPosition, cesiumDrawingToolsProperties) {
    ...
    CesiumService.prototype.prioritizePicks = function (pickedObjects) {
        ...
        var bestScore = -1;
        var chosen;
        pickedObjects.forEach(function (element) {
            var layerName = element.id.type;
            var score = _this.getScore(layerName);
    ...
    CesiumService.prototype.getScore = function (layerName) {
        switch (layerName) {
            ...
            if (drawingTool.isActivated) {
                ...
                drawingToolsHandler.setInputAction(function (click) {
                    ...
                    if (!pickedEntity) {
                        ...
                        var currDateTimestamp = __WEBPACK_IMPORTED_MODULE_4_moment__(new Date()).format('YYYYMMDD-hhmmss');
    ...
    CesiumService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__config_app_config__["a" /* AppConfig */], __WEBPACK_IMPORTED_MODULE_3__f24TrackData_service__["a" /* F24TrackDataService */]])
    ], CesiumService);
...
/***/ "./src/app/service/f24TrackData.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return F24TrackDataService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var F24TrackDataService = /** @class */ (function () {
    function F24TrackDataService(appConfig, http) {
        this.appConfig = appConfig;
        this.http = http;
    }
    F24TrackDataService.prototype.addMapMoveEndAction = function (cesiumViewer, dataSource, pickedEntity) {
        var _this = this;
        cesiumViewer.camera.moveEnd.addEventListener(function () {
            ...
            if (dataSource) {
                _this.updateTracks(dataSource, pickedEntity);
            }
        });
    };
    F24TrackDataService.prototype.updateTracks = function (dataSource, pickedEntity) {
        var _this = this;
        ...
        this.getTrackUpdateFromServer()
            ...
            for (var i = 0; i < Object.keys(data).length; i += 1) {
                ...
                if (key === 'full_count' || key === 'version') {
                    ...
                    _this.plotTrack(dataSource, bfPoint, key);
                }
                if (pickedEntity && pickedEntity.name === key && pickedEntity.type === _this.appConfig.LAYER_NAMES.airTrackLayerName) {
                    // selected track
                    // console.log('there is selected track', key);
                    _this.handleSelectedTrack(dataSource, key);
                }
            }
        });
    };
    F24TrackDataService.prototype.getTrackUpdateFromServer = function () {
        return this.http.get(this.appConfig.F24_URL + this.appConfig.BOUNDS + this.appConfig.OPTIONS);
    };
    F24TrackDataService.prototype.handleSelectedTrack = function (dataSource, selectedTrackF24Id) {
        ...
        // }
        var _this = this;
        this.getSelectedTrackFromServer(selectedTrackF24Id).subscribe(function (res) {
            // console.log(res);
            _this.plotTrail(dataSource, res.trail);
            _this.appendFlightData(dataSource, res);
        }, function (err) {
            console.log('Error occured', err);
        });
    };
    F24TrackDataService.prototype.getSelectedTrackFromServer = function (selectedTrackF24Id) {
        return this.http.get(this.appConfig.F24_SELECTED_FLIGHT_URL + selectedTrackF24Id);
    };
    F24TrackDataService.prototype.plotTrack = function (dataSource, trackRaw, key) {
        if (trackRaw) {
            var track = {
                f24id: key,
                id: trackRaw[0],
            ...
            if (track.lat != null && track.lon != null) {
                ...
                var showLabel = true;
                var newEntity = dataSource.entities.getById(track.f24id);
                if (newEntity) {
                }
                else {
    ...
    F24TrackDataService.prototype.plotTrail = function (dataSource, trailPoints) {
        // Draw polyline entity
        // console.log('trail points', trailPoints);
        var trailPositions = [];
        for (var i = 0; i < trailPoints.length; i += 1) {
            var iLat = trailPoints[i].lat;
            var iLon = trailPoints[i].lng;
            var iTime = trailPoints[i].ts;
            var iAlt = trailPoints[i].alt;
            var iPosition = Cesium.Cartesian3.fromDegrees(iLon, iLat, iAlt);
    ...
    F24TrackDataService.prototype.appendFlightData = function (dataSource, flightData) {
        if (flightData) {
            // console.log(parseInt(flightData.time.scheduled.departure));
            var sdDate = new Date(parseInt(flightData.time.scheduled.departure + '000'));
            // sdDate.setTime();
            var saDate = new Date(parseInt(flightData.time.scheduled.arrival + '000'));
            // saDate.setTime();
            var rdDate = new Date(parseInt(flightData.time.real.departure + '000'));
            // rdDate.setTime();
            var eaDate = new Date(parseInt(flightData.time.estimated.arrival + '000'));
            ...
            var entity = dataSource.entities.getById(details.f24id);
    ...
    F24TrackDataService.prototype.removeTrail = function (dataSource) {
    ...
    F24TrackDataService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__config_app_config__["a" /* AppConfig */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HttpClient */]])
    ], F24TrackDataService);
    return F24TrackDataService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__service_f24TrackData_service__ = __webpack_require__("./src/app/service/f24TrackData.service.ts");
...
var LoadMapLayerService = /** @class */ (function () {
    function LoadMapLayerService(cesiumService, appConfig, f24TrackDataService, http) {
        this.cesiumService = cesiumService;
        this.appConfig = appConfig;
        this.f24TrackDataService = f24TrackDataService;
        this.http = http;
    ...
    LoadMapLayerService.prototype.initRunwayLayer = function (cesiumViewer, cesiumStaticDataSources) {
        ...
        var fillColor = this.newColor('#f75231', 100); // Note: Modifies zone polygon
        // styling
        ...
        for (var i = 0; i <= endIdx; i += 1) {
            ...
            this.http.get(fullFileName)
                ...
                for (var _i = 0, _a = a.features; _i < _a.length; _i++) {
                    var airway = _a[_i];
                    if (_this.isWithinInterestZone(airway.geometry.coordinates)) {
    ...
    LoadMapLayerService.prototype.isWithinInterestZone = function (coordArr) {
        ...
        if (coordArr.length === 2) {
            var coordStart = coordArr[0];
            var coordEnd = coordArr[1];
    ...
    LoadMapLayerService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__service_cesium_service__["a" /* CesiumService */], __WEBPACK_IMPORTED_MODULE_3__config_app_config__["a" /* AppConfig */],
            __WEBPACK_IMPORTED_MODULE_2__service_f24TrackData_service__["a" /* F24TrackDataService */],
